...
export declare type KnownFields = 'grant_type' | 'redirect_uri' | 'client_id' | 'client_secret' | 'code';
export declare type KnownParams = 'client_id' | 'redirect_uri' | 'oauth_token';
export declare type KnownOauth1Params = 'oauth_verifier';
export declare type KnownHeaders = 'Authorization';
/**
 * ---------------------------------------------------
 * Independent types
 * ---------------------------------------------------
 ...
 */
export declare type Oauth2AccessToken = {
    /**
     * Value of the token
     */
    token: string;
 ...
 */
export declare type Oauth2ClientConfig = {
    clientId: string;
    clientSecret: string;
    callbackUrl: string;
    authorizeUrl?: string;
 ...
 */
export declare type Oauth1RequestToken = {
    token: string;
    secret: string;
} & Record<string, any>;
/**
 ...
 */
export declare type Oauth1AccessToken = Oauth1RequestToken;
/**
 * Base config for the Oauth 1.0 client
 */
export declare type Oauth1ClientConfig = Oauth2ClientConfig & {
    /**
